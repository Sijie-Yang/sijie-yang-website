...
content_zh: |
  ...
  **Friendship（ignore all this advice）：**
  ...
  1. **For specific networking**：Get clear about value offer、seeking，be explicit about exchange
  2. **For broad networking**：Use templates、set quotas，don't expect deep connection
  3. **For friendship**：Ignore all career calculations，just enjoy people
