...
title_zh: 城市环境认知与发展的显著模式与隐模式
title_en: The salient mode and hidden mode of urban environment cognition and development
date: 2021-12-18 09:00:00+0000
description: Discussion on Alan Penn's cognitive mechanism of human community
description_zh: 关于 Alan Penn 人类社区认知机制的讨论
tags: cognition
...
content_zh: |
  ...
  (<a href="https://thefairytaletraveler.com/2020/07/19/eiffel-tower-facts/">右</a>, <a href="https://frenchmoments.eu/historical-axis-of-paris-la-voie-triomphale/">左</a>)
  </div>

  另一方面，"意义"也可能指一种人们不易察觉的共存机制，即 Hillier 在《Space Is the Machine》中提到的虚拟社群（Hillier, 1996, p169）。基于 Hillier 的观点，建成环境的空间设计创造了一种基本模式，决定人们在特定场所有多大概率相遇，并最终影响社群中的共在（co-presence）与共知（co-awareness）（Hillier, 1996, p169）。例如，某居住区中某一空间的整合度（integration）很高，导致人们在此聚集、交谈甚至开展各类活动，社群成员逐渐对这一充满活力的社区空间形成认知，如图 2 所示。这类城市环境认知机制可称为**隐模式（hidden mode）**，因为人们常常并不清楚为何人群会聚集于此，以及这种局面是如何形成的。
  ...
  <div class="caption">
      图 2. 由城市环境认知隐模式驱动的、邻近居住区的成功公共空间。图片来源于网络。(<a href="https://thefairytaletraveler.com/2020/07/19/eiffel-tower-facts/">figure</a>)
  </div>
